...
if command -v node >/dev/null 2>&1; then
  cat src/00-plemmo-api.js src/02-data.js src/03-app-shell.js src/03b-plemmo-session.js src/03c-plemmo-catalogue.js src/03d-plemmo-orders.js src/03e-plemmo-cash.js \
      src/04-register-kitchen.js \
