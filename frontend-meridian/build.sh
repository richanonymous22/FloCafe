...
# self-contained IIFE with no dependency on later helpers.
{
  cat src/01-shell.html \
      ...
      src/02-data.js \
      src/03-app-shell.js \
      src/03b-plemmo-session.js \
      src/03c-plemmo-catalogue.js \
      src/03d-plemmo-orders.js \
      src/03e-plemmo-cash.js \
      src/03f-plemmo-inventory.js \
      src/03g-plemmo-tables.js \
      src/03h-plemmo-staff.js \
      src/03i-plemmo-reports.js \
      src/03j-plemmo-sync.js \
...
if command -v node >/dev/null 2>&1; then
  cat src/00-plemmo-api.js src/02-data.js src/03-app-shell.js src/03b-plemmo-session.js src/03c-plemmo-catalogue.js src/03d-plemmo-orders.js src/03e-plemmo-cash.js src/03f-plemmo-inventory.js src/03g-plemmo-tables.js src/03h-plemmo-staff.js src/03i-plemmo-reports.js src/03j-plemmo-sync.js \
      src/04-register-kitchen.js \
