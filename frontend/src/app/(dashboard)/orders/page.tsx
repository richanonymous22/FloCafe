    ...
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <select
          ...
          className="px-3 py-2 border border-border rounded-lg text-sm bg-card text-foreground/80 focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand"
        >
              ...
              <div key={heldOrder.tableId} className="bg-card rounded-xl border border-blue-200 overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-shadow">
                 ...
                 <div className="p-4 flex-1">
                   {heldOrder.items.map((item, idx) => (
                     <div key={idx} className="flex justify-between text-sm py-1 text-foreground/80">
                       <span>{item.quantity}x {item.product.name}</span>
                     </div>
                   ))}
                   {heldOrder.orderNotes && (
                     <div className="mt-3 text-sm italic text-muted-foreground bg-muted/50 p-2 rounded-lg">
                       &quot;{heldOrder.orderNotes}&quot;
                     </div>
                   )}
                 </div>
                    ...
                    {linkCustomerOrderId === order.id ? (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 px-3 py-1.5 text-sm border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                          autoFocus
                        />
                        <button
                          onClick={() => {
                ...
                <div className="px-4 py-3 flex-1">
                  ...
                  <div className="mt-3 pt-3 border-t border-dashed border-border space-y-1">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-foreground/80">{fmt(subtotal)}</span>
                    </div>
                    {discount > 0 && (
                      <div className="flex justify-between text-sm">
                    ...
                    {tax > 0 && (
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-foreground/80">{fmt(tax)}</span>
                      </div>
                    )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-card rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="cancelReason" className="block text-sm font-medium text-foreground/80 mb-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                />
              </div>
              ...
              {cancelModal.order.type === 'dine_in' && cancelModal.order.table && (
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="freeTable" className="text-sm text-foreground/80">
              ...
              {(cancelModal.order.status !== 'pending' || cancelModal.order.items?.some((i) => ['preparing', 'ready', 'served', 'completed'].includes(i.status))) && (
                <div>
                  <label htmlFor="overridePin" className="block text-sm font-medium text-foreground/80 mb-1">
      ...
      {voidItemModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-card rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
            ...
            <div>
              <label htmlFor="voidOverridePin" className="block text-sm font-medium text-foreground/80 mb-1">
                {t('orders.overridePinLabel')}
              </label>
              <input
                id="voidOverridePin"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-card rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  />
                </div>
              </div>
            ...
            {discountRequiresApproval && discountModal.value > 0 && (
              <div className="mt-4">
                <label className="block text-sm font-medium text-foreground/80 mb-1">{t('orders.managerPinLabel')}</label>
                <input
                  type="password"
                  value={discountPin}
                  ...
                  <div key={item.product_id} className="flex items-center gap-2 bg-muted/50 rounded-lg p-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <input
                        ...
                        className="w-full text-xs text-muted-foreground bg-transparent border-0 p-0 focus:outline-none placeholder:text-muted-foreground/60"
                      />
                    </div>
                    <div className="flex items-center gap-1">
                      <button
                        onClick={() => handleUpdateSelectionQty(item.product_id, item.quantity - 1)}
                        className="w-6 h-6 rounded bg-muted text-muted-foreground text-xs hover:bg-muted"
                      >-</button>
