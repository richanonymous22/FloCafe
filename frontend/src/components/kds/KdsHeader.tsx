    ...
    <div className="shrink-0 mb-4">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="flex items-center bg-muted rounded-lg p-0.5 ml-2" role="tablist">
            <button
          ...
          <button
            onClick={onLogout}
            className="min-w-11 min-h-11 p-2 hover:bg-muted rounded-lg text-muted-foreground ml-2"
            title={t('nav.logout')}
          >
            <LogOut size={20} />
          </button>
